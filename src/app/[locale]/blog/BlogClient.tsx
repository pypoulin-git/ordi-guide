  ...
  return (
    <>
      ...
      <section style={{
        ...
        <div aria-hidden style={{ position: 'absolute', top: '-50px', right: '-30px', width: '250px', height: '250px', borderRadius: '50%', background: 'rgba(255,255,255,0.03)' }} />
        <div aria-hidden style={{ position: 'absolute', top: 0, right: 0, bottom: 0, width: '35%', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', paddingRight: '2rem', color: 'white' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">{b.heroTitle}</h1>
          <p className="text-base md:text-lg text-white/70 max-w-lg leading-relaxed">{b.heroSubtitle}</p>
        </div>
      ...
      <section style={{ background: '#0f172a', padding: '3.5rem 0' }}>
        <div className="container text-center">
          <h2 className="text-3xl font-bold mb-4 text-white">{b.ctaTitle}</h2>
          <p className="mb-6 text-white/70 text-base max-w-md mx-auto">{b.ctaSubtitle}</p>
