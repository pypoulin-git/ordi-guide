 ...
 *   Connectique      — Ports, câbles, docks, USB-C, Thunderbolt
 *   Tendances        — Nouvelles technos, AI PC, ARM, innovations
 *   Achat malin      — Quand acheter, pièges à éviter, budget, astuces
 *
 * Tags (filtres # fins) :
 ...
 *   #usb-c #thunderbolt #dock #ports #chargement
 */
...
export const CATEGORIES = [
  ...
  { id: 'Connectique', label: 'Connectique',   color: '#0891b2', icon: '🔌' },
